...
class Performance extends React.Component {
  state = {
    ...
    currentPage: 1,
    imagesPerPage: 2,
    totalItems: this.props.data.image.length,
    showingItems: 0,
  ...
  render() {
    ...
    return (
      <div className="performance-container d-lg-flex" id="common-pl">
          ...
          <Fade timeout={3000}>
            <p
              ...
              dangerouslySetInnerHTML={{
                __html: this.props.data.description.replace(
                  /(?:\r\n|\r|\n)/g,
                  ' <br> '
                )
              }}
        ...
        <div className="bg-text-container d-none d-lg-block">
          <img src="https://res.cloudinary.com/dhuii7xg2/image/upload/c_scale,f_auto,q_auto,w_auto/v1614154622/perfor-text_g6hmu0.png" alt="Performance" className="img-fluid" />
        </div>
      </div>
    )
  }
