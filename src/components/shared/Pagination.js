    ...
    return (
      <div className="pagination-section" id="common-px">
        <div className="pagination-container d-flex justify-content-between">
          {prevData ? (
            <Link to={prevData.fields.slug} className="pagination-link">
              ...
              <div className="pagination-img-container">
                <img
                  srcSet={prevData.frontmatter.featuredImage}
                  alt={prevData.frontmatter.title}
                  className="lazyload pagination-img"
                />
                <p>{prevData.frontmatter.title}</p>
              </div>
            </Link>
          ) : (
            ''
          ...
          {nextData ? (
            <Link to={nextData.fields.slug} className="pagination-link">
              ...
              <div className="pagination-img-container">
                <img
                  src={nextData.frontmatter.featuredImage}
                  alt={prevData.frontmatter.title}
                  className="pagination-img"
                />
                <p>{nextData.frontmatter.title}</p>
              </div>
            </Link>
          ) : (
            ''
